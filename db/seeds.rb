...
transactions_data = {
  ...
  'Food' => [
    { amount: 75, date: '2020-08-01', notes: 'Weekly grocery shopping' },
    { amount: 70, date: '2020-08-08', notes: 'Weekly grocery shopping' },
    { amount: 72, date: '2020-08-15', notes: 'Weekly grocery shopping' },
    { amount: 64, date: '2020-08-22', notes: 'Weekly grocery shopping' },
    { amount: 68, date: '2020-08-29', notes: 'Weekly grocery shopping' },
    { amount: 70, date: '2020-09-05', notes: 'Weekly grocery shopping' },
    { amount: 72, date: '2020-09-12', notes: 'Weekly grocery shopping' },
    { amount: 80, date: '2020-09-19', notes: 'Weekly grocery shopping' },
    { amount: 60, date: '2020-09-26', notes: 'Weekly grocery shopping' },
    { amount: 72, date: '2020-10-03', notes: 'Weekly grocery shopping' },
    { amount: 75, date: '2020-10-10', notes: 'Weekly grocery shopping' },
    { amount: 61, date: '2020-10-17', notes: 'Weekly grocery shopping' },
    { amount: 70, date: '2020-10-24', notes: 'Weekly grocery shopping' },
  ],
  'Transportation' => [
